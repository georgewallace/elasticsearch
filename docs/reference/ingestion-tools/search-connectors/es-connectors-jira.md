...
The *Elastic Jira connector* is a [connector](es-connectors.md) for [Atlassian Jira](https://www.atlassian.com/software/jira). This connector is written in Python using the [Elastic connector framework](https://github.com/elastic/connectors/tree/main).
...
## **Elastic managed connector reference** [es-connectors-jira-native-connector-reference] 

::::::{dropdown} View **Elastic managed connector** reference

### Availability and prerequisites [es-connectors-jira-availability-prerequisites] 
...
### Create a Jira connector [es-connectors-jira-create-native-connector] 


## Use the UI [es-connectors-jira-create-use-the-ui] 
...
2. Follow the instructions to create a new native  **Jira** connector.

For additional operations, see [*Connectors UI in {{kib}}*](es-connectors-usage.md).


## Use the API [es-connectors-jira-create-use-the-api] 

You can use the {{es}} [Create connector API](https://www.elastic.co/guide/en/elasticsearch/reference/current/connector-apis.html) to create a new native Jira connector.
...
### Usage [es-connectors-jira-usage] 
...
### Compatibility [es-connectors-jira-compatability] 

* Jira Cloud, Jira Server, and Jira Data Center **versions 7 or later**.


### Configuration [es-connectors-jira-configuration] 
...
:   Email address to authenticate with Jira Cloud. Example: [jane.doe@example.com](mailto:jane.doe@example.com)
...
### Documents and syncs [es-connectors-jira-documents-syncs] 
...
* Permissions are not synced by default. You must first enable [DLS](es-connectors-jira.md#es-connectors-jira-document-level-security). Otherwise, **all documents** indexed to an Elastic deployment will be visible to **all users with access** to that Elastic Deployment.

::::



#### Sync types [es-connectors-jira-sync-types] 
...
### Sync rules [es-connectors-jira-sync-rules] 
...
#### Advanced sync rules example [es-connectors-jira-sync-rules-examples] 
...
### Document level security [es-connectors-jira-document-level-security] 

Document level security (DLS) enables you to restrict access to documents based on a user’s permissions. Refer to [configuration](es-connectors-jira.md#es-connectors-jira-configuration) on this page for how to enable DLS for this connector.
...
### Content Extraction [es-connectors-jira-content-extraction] 

See [Content extraction](es-connectors-content-extraction.md).


### Known issues [es-connectors-jira-known-issues] 
...
### Troubleshooting [es-connectors-jira-troubleshooting] 

See [Troubleshooting](es-connectors-troubleshooting.md).


### Security [es-connectors-jira-security] 
...
This connector is available as a self-managed **self-managed connector**. This self-managed connector is compatible with Elastic versions **8.7.0+**.
...
You can use the {{es}} [Create connector API](https://www.elastic.co/guide/en/elasticsearch/reference/current/connector-apis.html) to create a new self-managed Jira self-managed connector.
...
* Permissions are not synced by default. You must first enable [DLS](es-connectors-jira.md#es-connectors-jira-client-document-level-security). Otherwise, **all documents** indexed to an Elastic deployment will be visible to **all users with access** to that Elastic Deployment.
...
Document level security (DLS) enables you to restrict access to documents based on a user’s permissions. Refer to [configuration](es-connectors-jira.md#es-connectors-jira-client-configuration) on this page for how to enable DLS for this connector.
