...
To use this connector as a **self-managed connector**, see [*Self-managed connectors*](es-build-connector.md) Once set up, for additional usage operations, see [*Connectors UI in {{kib}}*](es-connectors-usage.md).
