...
The *Elastic Google Drive connector* is a [connector](es-connectors.md) for [Google Drive](https://www.google.com/drive). This connector is written in Python using the [Elastic connector framework](https://github.com/elastic/connectors/tree/main).
...
## **Elastic managed connector reference** [es-connectors-google-drive-native-connector-reference] 

:::::{dropdown} View **Elastic managed connector** reference

### Availability and prerequisites [es-connectors-google-drive-availability-and-prerequisites] 
...
### Usage [es-connectors-google-drive-usage] 
...
### Connector authentication prerequisites [es-connectors-google-drive-connector-authentication-prerequisites] 
...
#### Additional authentication prerequisites for domain-wide delegation [es-connectors-google-drive-additional-prerequisites-for-domain-wide-delegation] 
...
### Configuration [es-connectors-google-drive-configuration] 
...
:   Toggle to enable [document level security (DLS](es-dls.md). DLS is supported for the Google Drive connector. When enabled:
...
### Documents and syncs [es-connectors-google-drive-documents-and-syncs] 
...
* Permissions are not synced by default. You must first enable [DLS](es-connectors-google-drive.md#es-connectors-google-drive-document-level-security). Otherwise, **all documents** indexed to an Elastic deployment will be visible to **all users with access** to that Elastic Deployment.

::::



#### Sync types [es-connectors-google-drive-sync-types] 
...
### Sync rules [es-connectors-google-drive-sync-rules] 
...
### Document level security [es-connectors-google-drive-document-level-security] 

Document level security (DLS) enables you to restrict access to documents based on a user’s permissions. Refer to [configuration](es-connectors-google-drive.md#es-connectors-google-drive-configuration) on this page for how to enable DLS for this connector.
...
### Content extraction [es-connectors-google-drive-content-extraction] 

See [Content extraction](es-connectors-content-extraction.md) for more information.


### Known issues [es-connectors-google-drive-known-issues] 

There are currently no known issues for this connector.


### Troubleshooting [es-connectors-google-drive-troubleshooting] 

See [Troubleshooting](es-connectors-troubleshooting.md).


### Security [es-connectors-google-drive-security] 
...
* Permissions are not synced by default. You must first enable [DLS](es-connectors-google-drive.md#es-connectors-google-drive-client-document-level-security). Otherwise, **all documents** indexed to an Elastic deployment will be visible to **all users with access** to that Elastic Deployment.
...
Document level security (DLS) enables you to restrict access to documents based on a user’s permissions. Refer to [configuration](es-connectors-google-drive.md#es-connectors-google-drive-client-configuration) on this page for how to enable DLS for this connector.
