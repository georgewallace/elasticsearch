...
This action corresponds to the  [downsample API](indices-downsample-data-stream.md).
...
`fixed_interval`
:   (Required, string) The [fixed time interval](rollup-understanding-groups.md#rollup-understanding-group-intervals) into which the data will be downsampled.
